  ...
  <div class="mt-16 mb-16">
    <v-container class="content-container">
      ...
      <p class="mt-2">
        ...
        We will also introduce a NFT earning contract joined with Turtle to earn daily Turtle for holding.<br>
      </p>
      <p class="subheader-text text-primary mt-4">
      ...
      <p class="mt-2">
        2625 mint at 150,000 $TURTLE ~. This is to reward, thin out wallets of long term holders, and bring some chart stability.<br>
        ...
        <br><br>
        6000- CRO mints at 180.
        <br><br>
        Broken down in percentages below, this is how the funds from public minting plan to be allocated. Depending on the speed of minting process, funds will not be removed.
      </p>
      <ul>
        <li>
